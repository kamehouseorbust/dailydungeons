...
func _init_dict() -> void:
	var groups = [_new_GroupName.DWARF, _new_GroupName.WALL, _new_GroupName.FLOOR]
...
func _on_RemoveObject_sprite_removed(_remove_sprite, group_name, x, y) -> void:
